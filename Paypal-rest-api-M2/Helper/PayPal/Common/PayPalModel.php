...
use Ambab\BankDiscount\Helper\PayPal\Validation\JsonValidator;
                ...
                if (is_array($v)) {
                    ...
                    if (($clazz = ReflectionUtil::getPropertyClass(get_class($this), $k)) != null) {
                        ...
                        if (empty($v)) {
                            ...
                            /** @var self $o */
                            //$clazz = 'Ambab\BankDiscount\Helper\PayPal\Api\Payer';
                            $o = new $clazz();
                            ...
                            foreach ($v as $nk => $nv) {
                                if (is_array($nv)) {
                                    //$clazz = 'Ambab\BankDiscount\Helper\PayPal\Api\Transaction';
                                    $o = new $clazz();
                                    $o->fromArray($nv);
                                    $arr[$nk] = $o;
                                } else {
