...
namespace Ambab\BankDiscount\Helper\PayPal\Common;

use Ambab\BankDiscount\Helper\PayPal\Rest\ApiContext;
use Ambab\BankDiscount\Helper\PayPal\Rest\IResource;
use Ambab\BankDiscount\Helper\PayPal\Transport\PayPalRestCall;
...
class PayPalResourceModel extends PayPalModel implements IResource
{
     ...
     * Gets Links
     *
     * @return Ambab\BankDiscount\Helper\PayPal\Api\Links[]
     */
     ...
     */
    protected static function executeCall($url, $method, $payLoad, $headers = array(), $apiContext = null, $restCall = null, $handlers = array('Ambab\BankDiscount\Helper\PayPal\Handler\RestHandler'))
    {
