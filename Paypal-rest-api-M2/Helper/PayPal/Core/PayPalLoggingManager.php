...
namespace Ambab\BankDiscount\Helper\PayPal\Core;

use Ambab\BankDiscount\Helper\PayPal\Log\PayPalLogFactory;
...
class PayPalLoggingManager
{
    ...
    private function __construct($loggerName)
    {
        ...
        $factory = array_key_exists('log.AdapterFactory', $config) && in_array('Ambab\BankDiscount\Helper\PayPal\Log\PayPalLogFactory', class_implements($config['log.AdapterFactory'])) ? $config['log.AdapterFactory'] : 'Ambab\BankDiscount\Helper\PayPal\Log\PayPalDefaultLogFactory';
