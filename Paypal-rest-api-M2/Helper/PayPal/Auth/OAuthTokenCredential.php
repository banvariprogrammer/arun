...
namespace Ambab\BankDiscount\Helper\PayPal\Auth;

use Ambab\BankDiscount\Helper\PayPal\Cache\AuthorizationCache;
use Ambab\BankDiscount\Helper\PayPal\Common\PayPalResourceModel;
use Ambab\BankDiscount\Helper\PayPal\Core\PayPalHttpConfig;
use Ambab\BankDiscount\Helper\PayPal\Core\PayPalHttpConnection;
use Ambab\BankDiscount\Helper\PayPal\Core\PayPalLoggingManager;
use Ambab\BankDiscount\Helper\PayPal\Exception\PayPalConfigurationException;
use Ambab\BankDiscount\Helper\PayPal\Exception\PayPalConnectionException;
use Ambab\BankDiscount\Helper\PayPal\Handler\IPayPalHandler;
use Ambab\BankDiscount\Helper\PayPal\Rest\ApiContext;
use Ambab\BankDiscount\Helper\PayPal\Security\Cipher;
...
class OAuthTokenCredential extends PayPalResourceModel
{
     ...
     */
    public static $AUTH_HANDLER = 'Ambab\BankDiscount\Helper\PayPal\Handler\OauthHandler';
